...
function formatNumber(number) {
        const regionCode = global.BeatriceBC.config.language;
        if (isNaN(number))
...
function getPrefix(threadID) {
        ...
        let prefix = global.BeatriceBC.config.prefix;
...
const utils = {
        ...
        getExtFromUrl,
        getPrefix,
        getText: require("./core/languages/makeFuncGetLangs.js"),
        getTime,
        getType,
        isHexColor,
        isNumber,
        jsonStringifyColor,
        loading: require("./core/logger/loading.js"),
        log,
        logColor: require("./core/logger/logColor.js"),
        message,
        randomString,
        randomNumber,
        removeHomeDir,
