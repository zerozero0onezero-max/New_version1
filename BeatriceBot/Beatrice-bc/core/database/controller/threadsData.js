        ...
        async function create_(threadID, threadInfo) {
                ...
                const queue = new Promise(async function (resolve_, reject_) {
                        try {
                                ...
                                const newAdminsIDs = adminIDsArray.reduce(function (_, b) {
                                        _.push(b.id);
                                        return _;
                                }, []);

                                const newMembers = userInfoArray.reduce(function (arr, user) {
                ...
                return new Promise(function (resolve, reject) {
                        taskQueue.push(async function () {
                                try {
                                        ...
                                        const newMembers = [];
                                        const usersToProcess = Array.isArray(userInfo) ? userInfo : [];
                                        ...
                                        const adminIDsToProcess = Array.isArray(adminIDs) ? adminIDs : [];
                                        const newAdminsIDs = adminIDsToProcess.reduce(function (acc, cur) {
                                                acc.push(cur.id);
                                                return acc;
                                        }, []);
                                        let threadData = {
