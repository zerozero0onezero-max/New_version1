...
let pathLanguageFile = `${__dirname}/${global.BeatriceBC.config.language}.lang`;
if (!fs.existsSync(pathLanguageFile)) {
	log.warn("LANGUAGE", `Can't find language file ${global.BeatriceBC.config.language}.lang, using default language file "${__dirname}/en.lang"`);
