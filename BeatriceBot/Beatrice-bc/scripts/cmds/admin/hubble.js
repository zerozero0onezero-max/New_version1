...
const pathData = path.join(pathAssets, 'hubble', 'nasa.json');
if (!fs.existsSync(path.join(pathAssets, 'hubble')))
        fs.mkdirSync(path.join(pathAssets, 'hubble'), { recursive: true });
