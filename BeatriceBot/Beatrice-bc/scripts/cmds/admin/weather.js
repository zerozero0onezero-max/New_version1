...
Canvas.registerFont(
        path.join(pathAssets, 'font', 'BeVietnamPro-SemiBold.ttf'), {
        family: "BeVietnamPro-SemiBold"
});
Canvas.registerFont(
        path.join(pathAssets, 'font', 'BeVietnamPro-Regular.ttf'), {
...
module.exports = {
        ...
        ncStart: async function ({ args, message, envGlobal, getLang }) {
                ...
                const bg = await Canvas.loadImage(path.join(pathAssets, 'image', 'bgWeather.jpg'));
