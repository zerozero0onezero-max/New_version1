module.exports = {
        ...
        ncStart: async function ({ message, args, getLang, envGlobal }) {
                const noobCoreApis = global.utils?.noobCoreApis;
                const goatBotApi = noobCoreApis ? new noobCoreApis(envGlobal?.goatbotApikey) : null;
                if (!goatBotApi || !goatBotApi.isSetApiKey())
