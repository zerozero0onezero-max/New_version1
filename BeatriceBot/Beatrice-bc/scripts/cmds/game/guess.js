...
module.exports = {
  ...
  ncStart: async function ({ args, event, message, usersData }) {
    ...
    const timeout = setTimeout(() => {
      ...
      global.BeatriceBC.ncReply.delete(msg.messageID);
    }, 30 * 1000);

    global.BeatriceBC.ncReply.set(msg.messageID, {
  ...
  ncReply: async function ({ event, message, Reply, usersData }) {
    const senderID = event.senderID;
    ...
    global.BeatriceBC.ncReply.delete(Reply.messageID);
