...
function Home() {
  ...
  const [resourceStats, setResourceStats] = useState({ cpu: 18, memory: 34, network: '—' });
    ...
    <div className="app-shell">
      ...
      <main className="app-main">
        <header className="topbar">
          <div className="topbar-title"><ShieldCheck size={17} /><span>اختبار آمن · كل إجراء قابل للمراجعة</span></div>
        ...
        <div className="workspace-grid">
          ...
          <aside className="control-rail">
            ...
            <section className="panel rail-card">
              ...
              <div className="resource-row"><HardDrive /><span>الذاكرة</span><span className="resource-value">{resourceValues.memory}%</span><div className="meter"><i className="teal" style={{ width: `${resourceValues.memory}%` }} /></div></div>
